            ...
            <div className="bg-[url('../assets/register.jpg')] bg-cover bg-center min-h-screen flex items-center"
                ...
                <div className="max-w-[90%] mx-auto py-3 px-12 bg-white rounded-lg ">
                    <form action=""
                        ...
                        <h1 className="text-3xl font-bold text-center">Đăng ký tài khoản</h1>
                        <div className="flex gap-[10px]">
                            <div className="border border-gray-400 px-3 py-1 rounded-lg flex-1">
                                <h5 className="upercase text-gray-700 cursor-default">Họ và tên đệm</h5>
                        ...
                        <div className="border border-gray-400 px-3 py-1 rounded-lg">
                            <h5 className="upercase text-gray-700 cursor-default">Số điện thoại</h5>
                            <input type="tel" placeholder="0123..." className="outline-none" />
                        </div>
                        <div className="border border-gray-400 px-3 py-1 rounded-lg">
                        ...
                        <div className="border border-gray-400 px-3 py-1 rounded-lg">
                            <h5 className="upercase text-gray-700 cursor-default">Xác nhận lại mật khẩu</h5>
                            <input type="password" className="outline-none" />
                        </div>
                        <div className="flex items-center gap-2">
                            ...
                            <div>
                                ...
                                <span className="underline underline-offset-2">Điều khoản dịch vụ</span>
                                <span className="cursor-default"> và </span>
                                <span className="underline underline-offset-2">Chính sách bảo mật</span>
                            </div>
                        </div>
                        ...
                        <div className="text-center">
                            <span className="cursor-default">Quý khách đã có tài khoản? </span>
