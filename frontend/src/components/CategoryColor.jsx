...
//             try {
//                 const response = await axios.get(
//                     'http://117.103.207.132:8080/furni-shop/categories/color?page=1&pageSize=5&sortBy=colorId&dierction=asc', {
//                     headers: {
//                         Authorization: token,
//                     },
//                 });
...
//                 },
//             });
//             setColorData(prevData => prevData.filter(color => color.colorId !== colorId));
//         } catch (error) {
//             console.error('Failed to delete color:', error);
//         }
//     };
...
//                         onConfirm={() => handleDeleteColor(record.colorId)}  // Pass the correct colorId here
//                     >
